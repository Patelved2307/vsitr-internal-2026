...
export const PptSubmissionPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!githubCollaboratorsAdded) {
      showAlert('Collaborator Check Required', 'Please check the box confirming you have added the organizing committee member (@sihinternalvsitr-boop) as a collaborator to your GitHub repository.');
      return;
    }
        ...
        <div className="rounded-3xl bg-white p-5 sm:p-8 border border-slate-200/90 shadow-lg space-y-5">
          ...
          <div className="p-4 rounded-2xl bg-blue-50/70 border border-blue-200/80 text-xs space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-2.5 pt-0.5">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-3 py-1 rounded-xl bg-white border border-blue-200 text-[#1B3F8B] font-mono font-bold text-xs shadow-2xs hover:text-[#C1272D] transition"
              >
          ...
          <label className="flex items-start gap-3 pt-1 cursor-pointer select-none">
            ...
            <span className="text-xs font-bold text-slate-800 leading-relaxed">
              I confirm that I have pushed the 20% prototype code to this GitHub repository and added the organizing committee member (@sihinternalvsitr-boop) as a collaborator.
            </span>
          </label>
        </div>
