...
interface AuthContextType {
  ...
  // UI Navigation view
  activeTab: 'home' | 'rules' | 'faq' | 'support' | 'register' | 'login' | 'portal' | 'mentor' | 'admin' | 'ppt-submit' | 'timeline' | 'problem-statements' | 'team-edit';
  setActiveTab: (tab: 'home' | 'rules' | 'faq' | 'support' | 'register' | 'login' | 'portal' | 'mentor' | 'admin' | 'ppt-submit' | 'timeline' | 'problem-statements' | 'team-edit') => void;
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [activeTab, setActiveTab] = useState<'home' | 'rules' | 'faq' | 'support' | 'register' | 'login' | 'portal' | 'mentor' | 'admin' | 'ppt-submit' | 'timeline' | 'problem-statements' | 'team-edit'>('home');
